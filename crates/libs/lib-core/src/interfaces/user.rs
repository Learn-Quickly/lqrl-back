...
use crate::{core::error::CoreError, ctx::Ctx, model::user::{User, UserForCreate, UserForUpdate}};
...
pub trait IUserCommandRepository {
    ...
    async fn update_pwd(&self, ctx: &Ctx, user_id: i64, new_pwd_clear: &str) -> UserResult<()>;
}