...
CREATE TABLE lesson_progress (
  lesson_progress_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
...
CREATE TABLE exercise_completion (
  exercise_completion_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1000) PRIMARY KEY,
